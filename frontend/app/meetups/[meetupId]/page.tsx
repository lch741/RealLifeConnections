          ...
          <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-5 py-6 sm:px-8 lg:px-10">
            ...
            <header className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 shadow-sm transition hover:border-emerald-300"
                  href="/conversations"
                >
                  Conversations
                </Link>
                            ...
                            {isCreator ? (
                              <div className="flex flex-wrap gap-2">
                                <Link
                                  ...
                                  href={`/conversations/${meetup.id}/${participant.userId}`}
                                >
                                  Chat
                                </Link>
                                <button
